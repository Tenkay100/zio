...
async function handleTransferSubmit(e) {
  ...
  const swiftRef = generateSwiftRef();

  // Insert Transfer Record (Status: Pending)
  const { data: transferData, error } = await dbInsert('transfers', {
  ...
  await dbInsert('notifications', {
    ...
    message: `Your transfer of ${formatCurrency(amount, currentAccount.currency)} to ${name} has been initiated and is pending approval. Ref: ${swiftRef}`,
    type: 'info'
  });
